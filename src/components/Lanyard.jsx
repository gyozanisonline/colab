...
export default function Lanyard({
    ...
    fov = 20,
    transparent = true,
    name, setName, color, setColor, handleCreate
}) {
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false, name, setName, color, setColor, handleCreate }) {
            ...
            <group position={[0, 4, 0]}>
                ...
                <RigidBody position={[2, 0, 0]} ref={card} {...segmentProps} type={dragged ? 'kinematicPosition' : 'dynamic'}>
                    ...
                    >
                        ...
                        {/* Embedded Form - Bigger Scale */}
                        <Html transform position={[0, -0.05, 0.1]} scale={0.12} style={{ pointerEvents: 'none' }}>
                            <div
                                className="card-form"
                                onPointerDown={(e) => e.stopPropagation()}
                                style={{ pointerEvents: 'auto' }}
                            >
                                <h2 className="card-title">COLAB</h2>
                                <input
                                    type="text"
