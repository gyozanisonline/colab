...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = self.P_CENTERS or {
        ...
        --Jokers
        j_joker=            {order = 1,  unlocked = true,   start_alerted = true, discovered = true, start_discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 0, name = "MEGA Joker", pos = {x=0,y=0}, set = "Joker", effect = "Mult", cost_mult = 1.0, config = {mult = 500}},
...
function Game:main_menu(change_context) --True if main menu is accessed from the splash screen, false if it is skipped or accessed from the game
    ...
    if not G.offline_warned and love.platform and love.platform.isOffline then
        if love.platform and love.platform.isOffline and love.platform.isOffline() then
